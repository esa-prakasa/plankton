...
TRAIN_PATH = r'/home/lgr0220157/plankton/fold3/train'
TEST_PATH = r'/home/lgr0220157/plankton/fold3/test'
...
################################
#Modelcheckpoint
modelPath = r'/home/lgr0220157/plankton/model'
checkpointer = keras.callbacks.ModelCheckpoint(os.path.join(modelPath,'modelTopCamFold3.h5'), verbose=1, save_best_only=True)
...
modelJsonFileNm = "plank3.json"
modelH5FileNm = "plank3.h5"
modelBestNm = "theBestModelPlank3.hdf5"

model_json = modelRd.to_json()


with open(os.path.join(r'/home/lgr0220157/plankton/model',modelJsonFileNm), "w") as json_file:
    json_file.write(model_json)

modelRd.save_weights(os.path.join(r'/home/lgr0220157/plankton/model',modelH5FileNm))
...
pathToSave = r'/home/lgr0220157/plankton/result'
...
print("trainPlankUnet3.py has been run!")
